    ...
    if (keyrecorder.search("CADCAD") >= 0) { //Zelda's Lullaby
        ...
        songs[8].play();
            if (currentTime >= 18 && currentTime <= 6) {
                effects[3].play(5.5); //if time is between 6pm and 6am, Sun's Song changes night to day and cucco makes a cockadoodledoo 
            } else {
